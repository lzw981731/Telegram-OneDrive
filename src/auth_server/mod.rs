...
pub async fn spawn() -> Result<(Sender<String>, Sender<String>, Receiver<String>, Receiver<String>, AutoAbortHandle)> {
    ...
    let router = Router::new()
        ...
        .layer(Extension(SenderTG(tx_tg.clone())))
        .layer(Extension(SenderOD(tx_od.clone())));
    ...
    Ok((tx_tg, tx_od, rx_tg, rx_od, auto_abort_handle))
}
